...
display(dbutils.fs.ls('/Volumes/dbacademy_retail/v01/source_files/'))
...
print("db {}, cat {}".format(spark.catalog.currentDatabase(),spark.catalog.currentCatalog()))
...
# MAGIC %sql
# MAGIC -- Read back the data in the table
# MAGIC DESCRIBE HISTORY customers_ddl_df_table
