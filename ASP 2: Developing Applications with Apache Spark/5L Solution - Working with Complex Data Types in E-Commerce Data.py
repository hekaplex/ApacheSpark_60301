...
tags_json = events_df.select("tags").limit(1).collect()[0][0]
recent_orders_json = events_df.select("recent_orders").limit(1).collect()[0][0]
browsing_history_json = events_df.select("browsing_history").limit(1).collect()[0][0]
