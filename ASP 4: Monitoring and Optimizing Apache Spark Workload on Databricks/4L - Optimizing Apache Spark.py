...
## 1. Get the current number of cores on your cluster
## 2. Get the current number of shuffle partitions
## 3. Inspect the schema of the flights dataset
## 4. Preview the first 5 records of the flights dataset
<FILL-IN>
...
## Get the current number of partitions of the flights dataset
current_partitions = <FILL-IN>
...
## Reduce the number of partitions to 10 evenly distributed partitions, then check the number of partitions again
filtered_flights_df = <FILL-IN>
current_partitions = <FILL-IN>
...
## Optimize the above query by caching the dataset
<FILL-IN>
